...
their cost to members. How would you retrieve a list of 
...
--------
/*
How can you produce an ordered list of the first 10 
surnames in the members table? The list must not contain 
duplicates.
*/
...
booked. Produce an output table consisting of facility id
